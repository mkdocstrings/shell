...
Self-hosting the Insiders package makes it possible to depend on *mkdocstrings-shell* normally,
...
with [Twine]:
  ...
  [Github Releases]: https://github.com/pawamoy-insiders/mkdocstrings-shell/releases
...
>
> Now when running `pip install mkdocstrings-shell`,
...
Of course, you can use *mkdocstrings-shell Insiders* directly from `git`:
